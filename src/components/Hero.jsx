    ...
    <div className="hero bg-base-200 min-h-screen lg:pt-10 md:pt-20 pt-30 px-6.5 md:px-10 ">
      ...
      <div className="hero-content items-center flex-col lg:flex-row-reverse text-center md:text-left">
        <div className="avatar">
          <div className="ring-primary ring-offset-base-100 w-full md:w-96 rounded-full ring-2 ring-offset-2">
            <img src={HER} />
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start lg:mt-0 md:mt-10 mt-10">
          ...
          <a href="#results">
            <button className="btn btn-outline btn-base-content hover:bg-base-content hover:text-white her-style text-base">
